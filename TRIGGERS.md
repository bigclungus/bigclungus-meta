...
Model defaults to `grok-4.20-0309-reasoning` unless overridden with `[grok:grok-3-mini] <prompt>`.

When you receive this trigger:
1. Parse the model (default: `grok-4.20-0309-reasoning`) and prompt from the message
